...
public class WheelData
	...
	public PhysicsMaterial lastPhysicMaterial = s_nonExistingMaterial;	// A non-existing physic material ensures the first iteration to match the changes.
	...
	public static PhysicsMaterial s_nonExistingMaterial = new PhysicsMaterial();
	}
...
public class VehicleController : MonoBehaviour
	...
	void OnEnable ()
		...
		foreach (Wheel wheel in wheels)
			...
			wheel.wheelCollider.sprungMass = 0.0f;
	...
	void FixedUpdate ()
		...
		foreach (WheelData wd in m_wheelData)
			{
			if (wd.collider.sprungMass != 0.0f)
				wd.collider.sprungMass = 0.0f;
